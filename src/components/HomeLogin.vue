    ...
    <div class="card card-container pt-3 pb-4 radius">
      ...
      <form class="p-3 needs-validation form">
        <div class="form-group mb-3">
          <input type="text" v-model="state.username" class="form-control" :class="{ 'is-invalid': v$.username.$error }" id="usuario" placeholder="Usuario" />
          <div v-if="v$.username.$error" class="invalid-feedback errorMessage">
            {{ v$.username.$errors[0].$message }}
          </div>
        </div>
        <div class="form-group mb-3">
          <input type="password" v-model="state.password" class="form-control" :class="{ 'is-invalid': v$.password.$error }" id="contraseña" placeholder="Contraseña" />
